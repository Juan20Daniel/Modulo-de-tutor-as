...
class VerEntreIniJ extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            readDatos:[],
    ...
    }//Metodo para obtener los datos generales de las entrevistas iniciales 
    componentDidMount(){ 
        const Url = "http://localhost:3000/apis/list/ver/entrevista/inicial";
        axios.get(Url)
        .then(res=>{
            if(res.data.success){
            ...
            return error;
        });//Metodo para obtener los años en los que se registraron entrevistas  
        ...
        return(
            <div style={ sectionStyle } className="estatic">
                ...
                <div class="container-fluid">
                    <h4 class="text-center text-white">TODOS LOS RESULTADOS DE ENTREVISTA INICIAL A ESTUDIANTES</h4>
                    <br></br>
        ...
        return this.state.readDatos.map((datos, index)=>{
            return(
                <ul class="list-group list-group-horizontal">
                    ...
                    <li class="list-group-item text-center col-md-1">
                        <center>
                            <Link title="Ver grupo" to={'/verEntreIniGroupJ/'+this.props.match.params.id+"/"+datos.grupoTutores+"/"+this.state.campoAux} class="btn btn-primary">
